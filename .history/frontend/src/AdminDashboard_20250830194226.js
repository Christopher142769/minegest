...
import {
    ...
    FaPowerOff, // Ajout de l'icône déconnexion
    FaCog, // Ajout de l'icône de paramètres
...
function GasoilDashboard() {
    ...
    // const [stockRestant, setStockRestant] = useState(0); // Retire ce state, il n'est plus nécessaire.
    ...
    // Ancien useEffect, il est remplacé par le useMemo
    // useEffect(() => {
        ...
        <div className="dashboard-wrapper">
            ...
            >
                ...
                <div className="sidebar-footer">
                    ...
                    <Button variant="link"><FaPowerOff /></Button>
                </div>
            </motion.div>
                                            ...
                                            <Card.Body>
                                                ...
                                                <ResponsiveContainer width="100%" height={300}>
                                                    <BarChart data={getDailyDurationData}>
                                                        <CartesianGrid strokeDasharray="3 3" stroke="#ccc" />
                                                        <XAxis dataKey="name" stroke="#888" />
                                                        <YAxis stroke="#888" label={{ value: 'Durée (h)', angle: -90, position: 'insideLeft' }} />
                                                        <Tooltip formatter={(value) => `${value.toFixed(2)} heures`} contentStyle={{ backgroundColor: '#fff', border: '1px solid #ddd' }} itemStyle={{ color: '#333' }} />
