                        ...
                        <Card.Body>
                            ...
                            <ResponsiveContainer width="100%" height={300}>
                                <PieChart>
                                    ...
                                    >
                                        {/* Utilisation de couleurs diversifiées */}
                                        <Cell fill="#0088FE" /> {/* Bleu */}
                                        <Cell fill="#00C49F" /> {/* Vert */}
                                        <Cell fill="#FFBB28" /> {/* Jaune */}
                        ...
                        <Card.Body>
                            ...
                            <ResponsiveContainer width="100%" height={300}>
                                ...
                                >
                                    ...
                                    <Tooltip />
                                    <Legend />
                                    {/* Utilisation de couleurs diversifiées pour les barres */}
