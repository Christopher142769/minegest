...
const canvasRef = useRef(null);
    ...
    const fetchTruckers = async () => {
        try {
            const res = await fetch('https://minegest.onrender.com/api/truckers');
    ...
    const fetchBilan = async () => {
        try {
            const res = await fetch('https://minegest.onrender.com/api/gasoil/bilan');
            const data = await res.json();
            setBilanData(data);
        } catch (err) {
    ...
    const fetchApprovisionnements = async () => {
        try {
            const res = await fetch('https://minegest.onrender.com/api/approvisionnement');
            const data = await res.json();
    ...
    const fetchHistory = async () => {
        try {
            const res = await fetch('https://minegest.onrender.com/api/attributions');
    ...
    const handleDeleteAttribution = async (id) => {
        ...
        if (window.confirm('Êtes-vous sûr de vouloir supprimer cette attribution de gasoil ?')) {
            try {
                const res = await fetch(`https://minegest.onrender.com/api/attribution-gasoil/${id}`, {
                    method: 'DELETE',
                });
    ...
    const handleAttribGasoil = async (e) => {
        ...
        try {
            const res = await fetch(`https://minegest.onrender.com/api/truckers/${trucker._id}/gasoil`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
    ...
    const handleSaveData = async (e) => {
        ...
        try {
            const res = await fetch('https://minegest.onrender.com/api/gasoil/attribution-chrono', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
    ...
    const handleDeleteAppro = async (id) => {
        if (window.confirm('Êtes-vous sûr de vouloir supprimer cet approvisionnement ?')) {
            try {
                const res = await fetch(`https://minegest.onrender.com/api/approvisionnement/${id}`, {
                    method: 'DELETE',
                });
                if (!res.ok) {
                    const data = await res.json();
