...
const getDailyGasoilData = useMemo(() => {
    ...
    // Utilisez le tableau attributionsHistory qui contient les données d'attribution
...
}, [attributionsHistory, filterDate]); // N'oubliez pas de mettre attributionsHistory en dépendance
    return (
